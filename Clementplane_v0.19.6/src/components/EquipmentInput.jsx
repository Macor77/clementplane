...
import {
  ...
  getEquipmentCatalog,
} from '../services/equipmentCatalogService';
...
export default function EquipmentInput({
  ...
  useEffect(() => {
    ...
    getEquipmentCatalog()
      ...
      .catch((loadError) => {
        console.error('Chargement du référentiel matériel impossible :', loadError);
      });
  ...
  const addNew = async () => {
    ...
    try {
      const created = await addEquipmentToCatalog(cleaned);
      ...
      console.error('Création du matériel impossible :', createError);
      setError("Impossible d'ajouter ce matériel au référentiel.");
    } finally {
      setBusy(false);
    }
  };
