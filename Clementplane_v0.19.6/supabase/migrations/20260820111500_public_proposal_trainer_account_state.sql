-- Sprint 11.6.2 — Invitation à créer un compte après réponse publique
-- Ajoute uniquement une information booléenne non sensible à la proposition
-- publique : le formateur possède-t-il déjà un compte Formaplane ?
